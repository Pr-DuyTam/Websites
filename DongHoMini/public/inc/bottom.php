        ...
        <footer class="py-5 bg-warning">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-light">
                        ...
                        <h4><span class="badge text-white bg-success">A</span>
                            ...
                            <span class="badge text-white bg-info">C</span> Shop - Cửa hàng văn phòng phẩm</h4></a>
                ...
                <hr>
                <p class="m-0 text-center bg-warning fw-bolder">Copyright &copy; MiniShop 2023</p></div>
        </footer>
