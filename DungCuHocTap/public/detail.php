<?php include("inc/top.php"); ?>
  ...
  <div class="row">
    <div class="col-sm-9">      
      ...
      <div>
        <img width="500px" src="../<?php echo $mhct["hinhanh"]; ?>">
      </div>
      ...
      <div>
        ...
        <div class="card h-100 shadow">
            ...
            <div class="card-body p-4">
                <div class="text-center">
                    ...
                    <span class="text-muted text-decoration-line-through">
                      <?php echo number_format($m["giagoc"]); ?>đ</span><?php } // end if ?>
            ...
            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                <div class="text-center">
                  <a class="btn btn-outline-info mt-auto" href="index.php?action=chovaogio&id=<?php echo $d["id"]; ?>">
                    Chọn mua
                  </a>
                </div>
            </div>
